...
int main(int argc, char *argv[])
{
	...
	{     
		...
		*/
		if (strcmp(command, "cd") == 0) // strcmp compares 2 string ("command" "cd") by every character and returns a int. If the first character of two strings is equal, the next character of two strings are compared. This continues until the corresponding characters of two strings is null character.
		{
